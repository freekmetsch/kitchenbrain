...
<BottomSheet bind:open title="Recent activity">
	{#if loading}
		<p class="py-8 text-center text-sm text-base-content/50">Loading…</p>
	{:else if events.length === 0}
		<p class="py-8 text-center text-sm text-base-content/50">No activity yet.</p>
	{:else}
